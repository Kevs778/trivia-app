...
// 6. get all 4 answer choice buttons at once with querySelectorAll
...
getTriviaButton.addEventListener('click', () => {
    fetch(`https://opentdb.com/api.php?amount=1&category=${categoryMenu.value}&difficulty=${difficultyLevel}&type=multiple`)
...
radioButtons.forEach((radioBtn) =>{
    ...
    if (radioBtn.checked) {
        ...
        console.log(`Difficulty Level`, data.results[0].difficultyLevel);
}})
})
